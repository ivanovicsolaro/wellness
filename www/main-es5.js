  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | pages-create-account-create-account-module */
          [__webpack_require__.e("common"), __webpack_require__.e("pages-create-account-create-account-module")]).then(__webpack_require__.bind(null,
    ...
    function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(platform, splashScreen, statusBar, navCtrl, router, apiSrv, alertCtrl) {
        ...
        _createClass(AppComponent, [{
          ...
          key: "menuAction",
          value: function menuAction(page) {
            page.selected = true;
            this.appPages = this.appPages.map(function (p) {
                                ...
                                while (1) {
                                  switch (_context.prev = _context.next) {
                                    case 0:
                                      _context.prev = 0;
                                      _context.next = 3;
                                      return this.apiSrv.logout().toPromise();
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_http_interceptor_http_interceptor_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./services/http-interceptor/http-interceptor.service */
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_7__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_6__["SplashScreen"], {
          ...
          useClass: _services_http_interceptor_http_interceptor_service__WEBPACK_IMPORTED_MODULE_10__["HttpInterceptorService"],
          multi: true
        }],
      ...
      var AuthGuard = /*#__PURE__*/function () {
        ...
        _createClass(AuthGuard, [{
          ...
          value: function canActivate(next, state) {
            ...
            var urls = ['/login', '/create-account', '/register'];
            var guest = urls.includes(state.url);
            return this.authSrv.isLoggedIn().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (token) {
              if (token) {
      ...
      var ApiService = /*#__PURE__*/function () {
        ...
        _createClass(ApiService, [{
          ...
          value: function login(_ref) {
            ...
            var url = "".concat(this.apiUrl, "login");
            var params = {
              email: email,
              password: password
            };
          ...
          value: function logout() {
            ...
            var url = "".concat(this.apiUrl, "logout");
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(Storage.clear()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () {
              return _this4.http.get(url);
            }));
          }
          /**
          ...
          value: function isAuthenticated() {
            var url = "".concat(this.apiUrl, "is-authenticated");
          ...
          key: "checkCompanyCode",
          value: function checkCompanyCode(companyCode) {
            var url = "".concat(this.apiUrl, "company/code");
            var params = {
          ...
          value: function getCountryList() {
            var url = "".concat(this.apiUrl, "countries/list");
            return this.http.get(url);
          }
          /**
           * Register a new user
          ...
          value: function registerUser() {
            ...
            var url = "".concat(this.apiUrl, "user/register");
          ...
          value: function getCompanyList() {
            var url = "".concat(this.apiUrl, "company/list");
            return this.http.get(url);
          }
          /**
          ...
          value: function getCommunications() {
            var url = "".concat(this.apiUrl, "communication/list");
            return this.http.get(url);
          }
          /**
          ...
          key: "getCommunicationDetail",
          value: function getCommunicationDetail(id) {
            var url = "".concat(this.apiUrl, "communication/detail/").concat(id);
            return this.http.get(url);
          }
          /**
           * Get topics list
          ...
          key: "getTopicList",
          value: function getTopicList() {
            var url = "".concat(this.apiUrl, "topic/list");
            return this.http.get(url);
          }
          /**
           * Get the topic by id
          ...
          value: function getTopic(id) {
            var url = "".concat(this.apiUrl, "topic/detail/").concat(id);
            return this.http.get(url);
          }
          /**
           * Get resource list
          ...
          value: function getResourceList() {
            var url = "".concat(this.apiUrl, "resource/list");
            return this.http.get(url);
          }
          /**
           * Get resource list
          ...
          value: function getResource(id) {
            var url = "".concat(this.apiUrl, "resource/detail/").concat(id);
            return this.http.get(url);
          }
          /**
          ...
          key: "sendMessageContactForm",
          value: function sendMessageContactForm(content) {
            var url = "".concat(this.apiUrl, "user/contact-form");
          ...
          key: "getBenefit",
          value: function getBenefit(id) {
            var url = "".concat(this.apiUrl, "benefit/detail/").concat(id);
            return this.http.get(url);
          }
        }]);
      ...
      var AuthService = /*#__PURE__*/function () {
        ...
        _createClass(AuthService, [{
          ...
          value: function isLoggedIn() {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(Storage.get({
              key: 'token'
            })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (res) {
              var token = res.value;
              if (!token) return Promise.resolve(false);else {
                return _this5.apiSrv.isAuthenticated().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (user) {
    ...
    /***/
    function srcAppServicesHttpInterceptorHttpInterceptorServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var HttpInterceptorService = /*#__PURE__*/function () {
        function HttpInterceptorService(router) {
        ...
        _createClass(HttpInterceptorService, [{
          ...
          value: function intercept(req, next) {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(Storage.get({
              key: 'token'
            })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (response) {
      ...
      HttpInterceptorService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var environment = {
        production: false,
        apiUrl: 'https://appwellness.ar/' // apiUrl: 'http://localhost/wellness_backend/public/'
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! E:\Proyectos Ivan Ionic\wellness_app_ionic\src\main.ts */
      "./src/main.ts");
      /***/
    }
  }, [[0, "runtime", "vendor"]]]);
